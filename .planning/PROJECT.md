...
## Current Milestone: v1.1 Release & Deploy

**Goal:** id3-cli v1.0.0을 GitHub와 npm에 정식 배포하여 최종 사용자가 설치하고 바로 사용할 수 있게 한다.

**Target features:**
- 패키지 버전 1.0.0 업그레이드
- 사용자 문서(README 등) 정비 및 개선
- 배포 대상 파일/폴더 정리 (불필요한 산출물 제외)
- 배포 전 품질 점검 및 기타 필요 조치
...
- **Compatibility**: npx 하위 호환 불필요 — npm 글로벌 설치 방식만 지원
...
| npx 하위 호환 제거 | 글로벌 설치만 지원, 유지보수 단순화 | v1.1에서 결정 |

---
*Last updated: 2026-04-07 after milestone v1.1 started — Release & Deploy*
